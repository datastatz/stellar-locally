        ...
        <button className="brutalist-button openai button-1" onClick={handleClick}>
          <div className="openai-logo">
            <svg className="openai-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <circle style={{fill:"#8B5CF6"}} cx="12" cy="12" r="12"></circle>
              <circle style={{fill:"#A78BFA"}} cx="12" cy="9" r="3"></circle>
              <path style={{fill:"#C4B5FD"}} d="M7 20c0-2.76 2.24-5 5-5s5 2.24 5 5"></path>
            </svg>
          </div>
